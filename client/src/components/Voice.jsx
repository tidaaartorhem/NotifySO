...
class Voicestep1 extends Component {
  constructor(props) {
    super(props);
      ...
      <React.Fragment>
        ...
        <Container>
          <Row className="Badge">
            <div>
              We will be calling
              <span> {this.props.match.params.id}</span> in the next 5 minutes
              to confirm your subscription.
            </div>
            <div>
              Follow the instructions in the call to verify that this is your
              phone number.
            </div>
            <div>
